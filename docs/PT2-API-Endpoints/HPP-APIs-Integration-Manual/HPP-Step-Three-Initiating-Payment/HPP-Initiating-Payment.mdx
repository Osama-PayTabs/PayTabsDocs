...
This section is dedicated give you a sample API request payload using both the above mentioned required and optional paramters, along with showing you the response payload recieved upon using each request payload.



        <Tabs>
         <!-- Request/Response Paylod with Required Paramteters Paramters -->
            <TabItem value="RequestPayloadWithRequiredParamters" label="Required Paramters Sample Payloads" default>



 The below sample request payload will show you how you can pass the above-mentioned requried parameters, which are needed to be passed with valid values to perform a request. Along with the response payload recived after using this request payload.
        <Tabs>
            ...
            <TabItem value="ResponsePayload" label="Sample Response Payload">
             ...
             <TabItem value="RequestPayloadWithOptionalParamters" label="Optional Paramters Sample Payloads"> 
                      <!-- Request/Response Paylod with Optional Paramters -->
       
        The below sample request payload will show you how you can pass the above-mentioned optional parameters, which are needed to be passed with valid values to perform a request. Along with the response payload recived after using this request payload.
       <Tabs>
            <TabItem value="RequestPayload" label="Sample Request Payload" default>
                ```json
{
...
As mentioned in <span class="url">[Hosted Payment Page | Payment Workflow]({urls.hostedpworkflow})</span>, by creating the payment page, you will receive the redirect URL "redirect_url" within the response, which you will use to redirect your client to this payment page. Once you have redirected your client, the client browser will display the following page to the client.
